...
namespace _Project.World.Planet.Scripts.MarchingCubes
{
    ...
    public class MarchingCubesChunk : Chunk
    {
        ...
        private void Rebuild()
        {
            ...
            MeshFilter.sharedMesh = MarchingCubesGenerator.GenerateMesh(_grid, isoLevel); //and apply it to the mesh filter
        ...
        public void Configure(Vector3Int coord, int chunkSize, TerrainGenerator generator, float newIsoLevel, Vector3 worldMin, Vector3 worldMax)
        {
