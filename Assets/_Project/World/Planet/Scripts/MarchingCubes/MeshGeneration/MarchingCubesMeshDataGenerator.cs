...
namespace _Project.World.Planet.Scripts.MarchingCubes.MeshGeneration
{
    public static class MarchingCubesMeshDataGenerator
    {
        ...
        {
            MeshDataBuilder meshDataBuilder = new MeshDataBuilder(densityField); // the mesh data is used to store the vertices, normals and indices of the mesh. we use a builder to easily add new vertices and indices and then build the final mesh data at the end.
